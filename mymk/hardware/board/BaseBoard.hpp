...
protected:
  ...
  Key *key;
  unsigned int msg_len; // TODO: Message length should be different for
                        // switch_events and messages.
                        // TODO: Does exchanging a 1 bit flag to skip sending N
                        // bits speeds up the FPS significantly?
  bool is_connected;
  bool is_motherboard;
